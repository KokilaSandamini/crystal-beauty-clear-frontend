...
export default function Header() {
    ...
    return (
        <header className="w-full  h-[50px] flex justify-start items-center bg-gray-100 relative">
            ...
            </div>
            {
                isOpen && (
                    <div className="fixed lg:hidden z-[9999] top-0 left-0 bg-[#00000060] w-full h-screen flex">
                        <div className="w-[300px] h-full bg-white flex flex-col items-start justify-start p-4">
